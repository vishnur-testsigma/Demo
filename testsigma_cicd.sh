...
#*********************************************************************
#
# TESTSIGMA_API_KEY -> API key generated under Testsigma App >> Configurati>> API Ke
...
# For example, we are using $(date +"%Y%m%d%H%M") to use current date and time as build number.
#
#********START USER_INPUTS*********
TESTSIGMA_API_KEY=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJkYzM2ZjEzMy05NjZlLTRlOTItOWZkYi0xNDc3YTg5ZTk2OTIiLCJkb21haW4iOiJ0ZXN0ZGVtby5jb20iLCJ0ZW5hbnRJZCI6NjY0MzksImlzSWRsZVRpbWVvdXRDb25maWd1cmVkIjpmYWxzZX0.LLEOBdrHzdeDUSKpMy6ZZUN2CTJdOy2k9lSVFOhR_Z4mfMqyHOMrdUaIwFHJjXBE0ZyaSPLK6_GfWmwNYhia7w
TESTSIGMA_TEST_PLAN_ID=10003
...
For example, \"app_url\":\"https://app.testsigma.com/#/projects/.../report/executions/.../runs/.../environments\""
#**********************************
...
for i in "$@"
  ...
  case $i in
    ...
    printf "\nExample:\n bash testsigma_cicd.sh --apikey=<API_KEY> --testplanid=9697 --maxtimeinmins=60 --reportfilepath=./junit-report.xml\n\n"
    shift
    exit 1
    ;;
  esac
